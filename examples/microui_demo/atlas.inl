...
static mu_Rect atlas[ATLAS_FONT + 127 + MU_ICON_MAX ];
static void init_atlas(void) {
	atlas[ MU_ICON_CLOSE ] = (mu_Rect){ 88, 68, 16, 16 };
	atlas[ MU_ICON_CHECK ] = (mu_Rect){ 0, 0, 18, 18 };
	atlas[ MU_ICON_EXPANDED ] = (mu_Rect){ 118, 68, 7, 5 };
	atlas[ MU_ICON_COLLAPSED ] = (mu_Rect){ 113, 68, 5, 7 };
	atlas[ ATLAS_WHITE ] = (mu_Rect){ 125, 68, 3, 3 };
	atlas[ ATLAS_FONT+32 ] = (mu_Rect){ 84, 68, 2, 17 };
	atlas[ ATLAS_FONT+33 ] = (mu_Rect){ 39, 68, 3, 17 };
	atlas[ ATLAS_FONT+34 ] = (mu_Rect){ 114, 51, 5, 17 };
	atlas[ ATLAS_FONT+35 ] = (mu_Rect){ 34, 17, 7, 17 };
	atlas[ ATLAS_FONT+36 ] = (mu_Rect){ 28, 34, 6, 17 };
	atlas[ ATLAS_FONT+37 ] = (mu_Rect){ 58, 0, 9, 17 };
	atlas[ ATLAS_FONT+38 ] = (mu_Rect){ 103, 0, 8, 17 };
	atlas[ ATLAS_FONT+39 ] = (mu_Rect){ 86, 68, 2, 17 };
	atlas[ ATLAS_FONT+40 ] = (mu_Rect){ 42, 68, 3, 17 };
	atlas[ ATLAS_FONT+41 ] = (mu_Rect){ 45, 68, 3, 17 };
	atlas[ ATLAS_FONT+42 ] = (mu_Rect){ 34, 34, 6, 17 };
	atlas[ ATLAS_FONT+43 ] = (mu_Rect){ 40, 34, 6, 17 };
	atlas[ ATLAS_FONT+44 ] = (mu_Rect){ 48, 68, 3, 17 };
	atlas[ ATLAS_FONT+45 ] = (mu_Rect){ 51, 68, 3, 17 };
	atlas[ ATLAS_FONT+46 ] = (mu_Rect){ 54, 68, 3, 17 };
	atlas[ ATLAS_FONT+47 ] = (mu_Rect){ 124, 34, 4, 17 };
	atlas[ ATLAS_FONT+48 ] = (mu_Rect){ 46, 34, 6, 17 };
	atlas[ ATLAS_FONT+49 ] = (mu_Rect){ 52, 34, 6, 17 };
	atlas[ ATLAS_FONT+50 ] = (mu_Rect){ 58, 34, 6, 17 };
	atlas[ ATLAS_FONT+51 ] = (mu_Rect){ 64, 34, 6, 17 };
	atlas[ ATLAS_FONT+52 ] = (mu_Rect){ 70, 34, 6, 17 };
	atlas[ ATLAS_FONT+53 ] = (mu_Rect){ 76, 34, 6, 17 };
	atlas[ ATLAS_FONT+54 ] = (mu_Rect){ 82, 34, 6, 17 };
	atlas[ ATLAS_FONT+55 ] = (mu_Rect){ 88, 34, 6, 17 };
	atlas[ ATLAS_FONT+56 ] = (mu_Rect){ 94, 34, 6, 17 };
	atlas[ ATLAS_FONT+57 ] = (mu_Rect){ 100, 34, 6, 17 };
	atlas[ ATLAS_FONT+58 ] = (mu_Rect){ 57, 68, 3, 17 };
	atlas[ ATLAS_FONT+59 ] = (mu_Rect){ 60, 68, 3, 17 };
	atlas[ ATLAS_FONT+60 ] = (mu_Rect){ 106, 34, 6, 17 };
	atlas[ ATLAS_FONT+61 ] = (mu_Rect){ 112, 34, 6, 17 };
	atlas[ ATLAS_FONT+62 ] = (mu_Rect){ 118, 34, 6, 17 };
	atlas[ ATLAS_FONT+63 ] = (mu_Rect){ 119, 51, 5, 17 };
	atlas[ ATLAS_FONT+64 ] = (mu_Rect){ 18, 0, 10, 17 };
	atlas[ ATLAS_FONT+65 ] = (mu_Rect){ 41, 17, 7, 17 };
	atlas[ ATLAS_FONT+66 ] = (mu_Rect){ 48, 17, 7, 17 };
	atlas[ ATLAS_FONT+67 ] = (mu_Rect){ 55, 17, 7, 17 };
	atlas[ ATLAS_FONT+68 ] = (mu_Rect){ 111, 0, 8, 17 };
	atlas[ ATLAS_FONT+69 ] = (mu_Rect){ 0, 35, 6, 17 };
	atlas[ ATLAS_FONT+70 ] = (mu_Rect){ 6, 35, 6, 17 };
	atlas[ ATLAS_FONT+71 ] = (mu_Rect){ 119, 0, 8, 17 };
	atlas[ ATLAS_FONT+72 ] = (mu_Rect){ 18, 17, 8, 17 };
	atlas[ ATLAS_FONT+73 ] = (mu_Rect){ 63, 68, 3, 17 };
	atlas[ ATLAS_FONT+74 ] = (mu_Rect){ 66, 68, 3, 17 };
	atlas[ ATLAS_FONT+75 ] = (mu_Rect){ 62, 17, 7, 17 };
	atlas[ ATLAS_FONT+76 ] = (mu_Rect){ 12, 51, 6, 17 };
	atlas[ ATLAS_FONT+77 ] = (mu_Rect){ 28, 0, 10, 17 };
	atlas[ ATLAS_FONT+78 ] = (mu_Rect){ 67, 0, 9, 17 };
	atlas[ ATLAS_FONT+79 ] = (mu_Rect){ 76, 0, 9, 17 };
	atlas[ ATLAS_FONT+80 ] = (mu_Rect){ 69, 17, 7, 17 };
	atlas[ ATLAS_FONT+81 ] = (mu_Rect){ 85, 0, 9, 17 };
	atlas[ ATLAS_FONT+82 ] = (mu_Rect){ 76, 17, 7, 17 };
	atlas[ ATLAS_FONT+83 ] = (mu_Rect){ 18, 51, 6, 17 };
	atlas[ ATLAS_FONT+84 ] = (mu_Rect){ 24, 51, 6, 17 };
	atlas[ ATLAS_FONT+85 ] = (mu_Rect){ 26, 17, 8, 17 };
	atlas[ ATLAS_FONT+86 ] = (mu_Rect){ 83, 17, 7, 17 };
	atlas[ ATLAS_FONT+87 ] = (mu_Rect){ 38, 0, 10, 17 };
	atlas[ ATLAS_FONT+88 ] = (mu_Rect){ 90, 17, 7, 17 };
	atlas[ ATLAS_FONT+89 ] = (mu_Rect){ 30, 51, 6, 17 };
	atlas[ ATLAS_FONT+90 ] = (mu_Rect){ 36, 51, 6, 17 };
	atlas[ ATLAS_FONT+91 ] = (mu_Rect){ 69, 68, 3, 17 };
	atlas[ ATLAS_FONT+92 ] = (mu_Rect){ 124, 51, 4, 17 };
	atlas[ ATLAS_FONT+93 ] = (mu_Rect){ 72, 68, 3, 17 };
	atlas[ ATLAS_FONT+94 ] = (mu_Rect){ 42, 51, 6, 17 };
	atlas[ ATLAS_FONT+95 ] = (mu_Rect){ 15, 68, 4, 17 };
	atlas[ ATLAS_FONT+96 ] = (mu_Rect){ 48, 51, 6, 17 };
	atlas[ ATLAS_FONT+97 ] = (mu_Rect){ 54, 51, 6, 17 };
	atlas[ ATLAS_FONT+98 ] = (mu_Rect){ 97, 17, 7, 17 };
	atlas[ ATLAS_FONT+99 ] = (mu_Rect){ 0, 52, 5, 17 };
	atlas[ ATLAS_FONT+100 ] = (mu_Rect){ 104, 17, 7, 17 };
	atlas[ ATLAS_FONT+101 ] = (mu_Rect){ 60, 51, 6, 17 };
	atlas[ ATLAS_FONT+102 ] = (mu_Rect){ 19, 68, 4, 17 };
	atlas[ ATLAS_FONT+103 ] = (mu_Rect){ 66, 51, 6, 17 };
	atlas[ ATLAS_FONT+104 ] = (mu_Rect){ 111, 17, 7, 17 };
	atlas[ ATLAS_FONT+105 ] = (mu_Rect){ 75, 68, 3, 17 };
	atlas[ ATLAS_FONT+106 ] = (mu_Rect){ 78, 68, 3, 17 };
	atlas[ ATLAS_FONT+107 ] = (mu_Rect){ 72, 51, 6, 17 };
	atlas[ ATLAS_FONT+108 ] = (mu_Rect){ 81, 68, 3, 17 };
	atlas[ ATLAS_FONT+109 ] = (mu_Rect){ 48, 0, 10, 17 };
	atlas[ ATLAS_FONT+110 ] = (mu_Rect){ 118, 17, 7, 17 };
	atlas[ ATLAS_FONT+111 ] = (mu_Rect){ 0, 18, 7, 17 };
	atlas[ ATLAS_FONT+112 ] = (mu_Rect){ 7, 18, 7, 17 };
	atlas[ ATLAS_FONT+113 ] = (mu_Rect){ 14, 34, 7, 17 };
	atlas[ ATLAS_FONT+114 ] = (mu_Rect){ 23, 68, 4, 17 };
	atlas[ ATLAS_FONT+115 ] = (mu_Rect){ 5, 52, 5, 17 };
	atlas[ ATLAS_FONT+116 ] = (mu_Rect){ 27, 68, 4, 17 };
	atlas[ ATLAS_FONT+117 ] = (mu_Rect){ 21, 34, 7, 17 };
	atlas[ ATLAS_FONT+118 ] = (mu_Rect){ 78, 51, 6, 17 };
	atlas[ ATLAS_FONT+119 ] = (mu_Rect){ 94, 0, 9, 17 };
	atlas[ ATLAS_FONT+120 ] = (mu_Rect){ 84, 51, 6, 17 };
	atlas[ ATLAS_FONT+121 ] = (mu_Rect){ 90, 51, 6, 17 };
	atlas[ ATLAS_FONT+122 ] = (mu_Rect){ 10, 68, 5, 17 };
	atlas[ ATLAS_FONT+123 ] = (mu_Rect){ 31, 68, 4, 17 };
	atlas[ ATLAS_FONT+124 ] = (mu_Rect){ 96, 51, 6, 17 };
	atlas[ ATLAS_FONT+125 ] = (mu_Rect){ 35, 68, 4, 17 };
	atlas[ ATLAS_FONT+126 ] = (mu_Rect){ 102, 51, 6, 17 };
	atlas[ ATLAS_FONT+127 ] = (mu_Rect){ 108, 51, 6, 17 };
}
