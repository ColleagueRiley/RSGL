...
var ASM_CONSTS = {
 ...
 268103: () => { return 'Asyncify' in Module; },  
 268136: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268207: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268264: () => { return window.mouseX || 0; },  
 268295: () => { return window.mouseY || 0; },  
 268326: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 268473: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268526: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 268806: () => { return window.innerWidth; },  
 268836: () => { return window.innerHeight; },  
 268867: () => { Module.requestFullscreen(false, true); },  
 268906: () => { Module.exitFullscreen(false, true); },  
 268942: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 245344;
