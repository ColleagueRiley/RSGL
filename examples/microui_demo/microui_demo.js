...
var ASM_CONSTS = {
 ...
 131632: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 131703: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 131760: () => { return window.mouseX || 0; },  
 131791: () => { return window.mouseY || 0; },  
 131822: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 131969: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 132022: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 132302: () => { return window.innerWidth; },  
 132332: () => { return window.innerHeight; },  
 132363: () => { Module.requestFullscreen(false, true); },  
 132402: () => { Module.exitFullscreen(false, true); },  
 132438: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 108824;
