...
var ASM_CONSTS = {
  72888: () => { Module.canvas.focus(); },  
 72913: () => { return window.innerWidth; },  
 72943: () => { return window.innerHeight; },  
 72974: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 ...
 74064: () => { document.getElementById('canvas').style.cursor = 'none'; }
};
