...
var ASM_CONSTS = {
 ...
 249448: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 249519: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 249576: () => { return window.mouseX || 0; },  
 249607: () => { return window.mouseY || 0; },  
 249638: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 249785: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 249838: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 250118: () => { return window.innerWidth; },  
 250148: () => { return window.innerHeight; },  
 250179: () => { Module.requestFullscreen(false, true); },  
 250218: () => { Module.exitFullscreen(false, true); },  
 250254: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
