...
var ASM_CONSTS = {
  109560: () => { Module.canvas.focus(); },  
 109585: ($0, $1, $2, $3, $4) => { var data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = document.getElementById("canvas").getContext("2d"); let image = context.getImageData(0, 0, $1, $2); image.data.set(data); context.putImageData(image, 0, $4 - $2); },  
 ...
 111792: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111863: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111920: () => { return window.mouseX || 0; },  
 111951: () => { return window.mouseY || 0; },  
 111982: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 112129: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112182: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 112462: () => { return window.innerWidth; },  
 112492: () => { return window.innerHeight; },  
 112523: () => { Module.requestFullscreen(false, true); },  
 112562: () => { Module.exitFullscreen(false, true); },  
 112598: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 105880;
