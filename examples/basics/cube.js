...
var ASM_CONSTS = {
 ...
 248512: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 248583: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 248640: () => { return window.mouseX || 0; },  
 248671: () => { return window.mouseY || 0; },  
 248702: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 248849: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 248902: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 249182: () => { return window.innerWidth; },  
 249212: () => { return window.innerHeight; },  
 249243: () => { Module.requestFullscreen(false, true); },  
 249282: () => { Module.exitFullscreen(false, true); },  
 249318: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
