...
var ASM_CONSTS = {
  246324: () => { Module.canvas.focus(); },  
 246349: ($0, $1, $2, $3, $4) => { var data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = document.getElementById("canvas").getContext("2d"); let image = context.getImageData(0, 0, $1, $2); image.data.set(data); context.putImageData(image, 0, $4 - $2); },  
 ...
 248556: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 248627: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 248684: () => { return window.mouseX || 0; },  
 248715: () => { return window.mouseY || 0; },  
 248746: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 248893: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 248946: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 249226: () => { return window.innerWidth; },  
 249256: () => { return window.innerHeight; },  
 249287: () => { Module.requestFullscreen(false, true); },  
 249326: () => { Module.exitFullscreen(false, true); },  
 249362: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
