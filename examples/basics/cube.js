...
var ASM_CONSTS = {
 ...
 113036: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 113107: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 113164: () => { return window.mouseX || 0; },  
 113195: () => { return window.mouseY || 0; },  
 113226: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 113373: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113426: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 113706: () => { return window.innerWidth; },  
 113736: () => { return window.innerHeight; },  
 113767: () => { Module.requestFullscreen(false, true); },  
 113806: () => { Module.exitFullscreen(false, true); },  
 113842: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 107760;
