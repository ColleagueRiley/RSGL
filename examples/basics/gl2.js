...
var ASM_CONSTS = {
 ...
 249887: () => { return 'Asyncify' in Module; },  
 249920: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 249991: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 250048: () => { return window.mouseX || 0; },  
 250079: () => { return window.mouseY || 0; },  
 250110: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 250257: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 250310: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 250590: () => { return window.innerWidth; },  
 250620: () => { return window.innerHeight; },  
 250651: () => { Module.requestFullscreen(false, true); },  
 250690: () => { Module.exitFullscreen(false, true); },  
 250726: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 244020;
