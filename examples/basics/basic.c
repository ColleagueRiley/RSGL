...
int main() {
	...
	RSGL_renderer* renderer_opengl11 = RSGL_renderer_init(RSGL_GL1_rendererProc(), RSGL_AREA(500, 500), RGFW_getProcAddress_OpenGL);
	RSGL_renderer* renderer_opengl = RSGL_renderer_init(RSGL_GL_rendererProc(), RSGL_AREA(500, 500), RGFW_getProcAddress_OpenGL);
