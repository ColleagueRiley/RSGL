...
var ASM_CONSTS = {
 ...
 249943: () => { return 'Asyncify' in Module; },  
 249976: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 250047: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 250104: () => { return window.mouseX || 0; },  
 250135: () => { return window.mouseY || 0; },  
 250166: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 250313: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 250366: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 250646: () => { return window.innerWidth; },  
 250676: () => { return window.innerHeight; },  
 250707: () => { Module.requestFullscreen(false, true); },  
 250746: () => { Module.exitFullscreen(false, true); },  
 250782: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 243992;
